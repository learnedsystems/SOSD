...
#ifdef FAST_MODE
#define INSTANTIATE_TEMPLATES(func_name, type_name) template void func_name<BranchingBinarySearch>(sosd::Benchmark<type_name, BranchingBinarySearch>&, bool)
#else
...
#ifdef FAST_MODE
#define INSTANTIATE_TEMPLATES_RMI(func_name, type_name) template void func_name<BranchingBinarySearch>(sosd::Benchmark<type_name, BranchingBinarySearch>&, bool, const std::string&)
#else
