...
struct bloomfilter_runtime_sectorized {
...
//using hash_fn_1 = dtl::hash::identity<T>;
  ...
  bloomfilter_runtime_sectorized() = default;

  bloomfilter_runtime_sectorized(bloomfilter_runtime_sectorized&& src)
  ...
  ~bloomfilter_runtime_sectorized() {
    if (instance != nullptr) destruct();
  }

  bloomfilter_runtime_sectorized&
  operator=(bloomfilter_runtime_sectorized&& src) {
    m = src.m;
    h = src.h;
    k = src.k;
    instance = src.instance;
...
//  using bf1_k1_t = dtl::bloomfilter_h1<key_t, hash_fn_0, word_t, dtl::mem::numa_allocator<word_t>, 1, true>;

//  using bf1_k1_mod_t = dtl::bloomfilter_h1_mod<key_t, hash_fn_0, word_t, dtl::mem::numa_allocator<word_t>, 1, true>;
#ifndef USE_BF2
  using bf1_k2_t = dtl::bloomfilter_h1<key_t, hash_fn_0, word_t, dtl::mem::numa_allocator<word_t>, 2, true>;
//  using bf1_k3_t = dtl::bloomfilter_h1<key_t, hash_fn_0, word_t, dtl::mem::numa_allocator<word_t>, 3, true>;
  using bf1_k4_t = dtl::bloomfilter_h1<key_t, hash_fn_0, word_t, dtl::mem::numa_allocator<word_t>, 4, true>;
//  using bf1_k5_t = dtl::bloomfilter_h1<key_t, hash_fn_0, word_t, dtl::mem::numa_allocator<word_t>, 5, true>;
//  using bf1_k6_t = dtl::bloomfilter_h1<key_t, hash_fn_0, word_t, dtl::mem::numa_allocator<word_t>, 6, true>;

  using bf1_k2_mod_t = dtl::bloomfilter_h1_mod<key_t, hash_fn_0, word_t, dtl::mem::numa_allocator<word_t>, 2, true>;
//  using bf1_k3_mod_t = dtl::bloomfilter_h1_mod<key_t, hash_fn_0, word_t, dtl::mem::numa_allocator<word_t>, 3, true>;
  using bf1_k4_mod_t = dtl::bloomfilter_h1_mod<key_t, hash_fn_0, word_t, dtl::mem::numa_allocator<word_t>, 4, true>;
//  using bf1_k5_mod_t = dtl::bloomfilter_h1_mod<key_t, hash_fn_0, word_t, dtl::mem::numa_allocator<word_t>, 5, true>;
//  using bf1_k6_mod_t = dtl::bloomfilter_h1_mod<key_t, hash_fn_0, word_t, dtl::mem::numa_allocator<word_t>, 6, true>;
#else
  #warning "Using Bloom filter with H=2."
using bf1_k2_t = dtl::bloomfilter_h2<key_t, hash_fn_0, hash_fn_1, word_t, dtl::mem::numa_allocator<word_t>, 2, true>;
//using bf1_k3_t = dtl::bloomfilter_h2<key_t, hash_fn_0, hash_fn_1, word_t, dtl::mem::numa_allocator<word_t>, 3, true>;
using bf1_k4_t = dtl::bloomfilter_h2<key_t, hash_fn_0, hash_fn_1, word_t, dtl::mem::numa_allocator<word_t>, 4, true>;
//using bf1_k5_t = dtl::bloomfilter_h2<key_t, hash_fn_0, hash_fn_1, word_t, dtl::mem::numa_allocator<word_t>, 5, true>;
using bf1_k6_t = dtl::bloomfilter_h2<key_t, hash_fn_0, hash_fn_1, word_t, dtl::mem::numa_allocator<word_t>, 6, true>;

using bf1_k2_mod_t = dtl::bloomfilter_h2_mod<key_t, hash_fn_0, hash_fn_1, word_t, dtl::mem::numa_allocator<word_t>, 2, true>;
//using bf1_k3_mod_t = dtl::bloomfilter_h2_mod<key_t, hash_fn_0, hash_fn_1, word_t, dtl::mem::numa_allocator<word_t>, 3, true>;
using bf1_k4_mod_t = dtl::bloomfilter_h2_mod<key_t, hash_fn_0, hash_fn_1, word_t, dtl::mem::numa_allocator<word_t>, 4, true>;
//using bf1_k5_mod_t = dtl::bloomfilter_h2_mod<key_t, hash_fn_0, hash_fn_1, word_t, dtl::mem::numa_allocator<word_t>, 5, true>;
//using bf1_k6_mod_t = dtl::bloomfilter_h2_mod<key_t, hash_fn_0, hash_fn_1, word_t, dtl::mem::numa_allocator<word_t>, 6, true>;
#endif

  using bf2_k2_t = dtl::bloomfilter_h2<key_t, hash_fn_0, hash_fn_1, word_t, dtl::mem::numa_allocator<word_t>, 2, true>;
//  using bf2_k3_t = dtl::bloomfilter_h2<key_t, hash_fn_0, hash_fn_1, word_t, dtl::mem::numa_allocator<word_t>, 3, true>;
  using bf2_k4_t = dtl::bloomfilter_h2<key_t, hash_fn_0, hash_fn_1, word_t, dtl::mem::numa_allocator<word_t>, 4, true>;
//  using bf2_k5_t = dtl::bloomfilter_h2<key_t, hash_fn_0, hash_fn_1, word_t, dtl::mem::numa_allocator<word_t>, 5, true>;
//  using bf2_k6_t = dtl::bloomfilter_h2<key_t, hash_fn_0, hash_fn_1, word_t, dtl::mem::numa_allocator<word_t>, 6, true>;
//  using bf2_k7_t = dtl::bloomfilter_h2<key_t, hash_fn_0, hash_fn_1, word_t, dtl::mem::numa_allocator<word_t>, 7, true>;

  using bf2_k2_mod_t = dtl::bloomfilter_h2_mod<key_t, hash_fn_0, hash_fn_1, word_t, dtl::mem::numa_allocator<word_t>, 2, true>;
//  using bf2_k3_mod_t = dtl::bloomfilter_h2_mod<key_t, hash_fn_0, hash_fn_1, word_t, dtl::mem::numa_allocator<word_t>, 3, true>;
  using bf2_k4_mod_t = dtl::bloomfilter_h2_mod<key_t, hash_fn_0, hash_fn_1, word_t, dtl::mem::numa_allocator<word_t>, 4, true>;
//  using bf2_k5_mod_t = dtl::bloomfilter_h2_mod<key_t, hash_fn_0, hash_fn_1, word_t, dtl::mem::numa_allocator<word_t>, 5, true>;
//  using bf2_k6_mod_t = dtl::bloomfilter_h2_mod<key_t, hash_fn_0, hash_fn_1, word_t, dtl::mem::numa_allocator<word_t>, 6, true>;
//  using bf2_k7_mod_t = dtl::bloomfilter_h2_mod<key_t, hash_fn_0, hash_fn_1, word_t, dtl::mem::numa_allocator<word_t>, 7, true>;


//  using bf3_k6_t = dtl::bloomfilter_h3<key_t, hash_fn_0, hash_fn_1, hash_fn_2, word_t, dtl::mem::numa_allocator<word_t>, 6,   true>;
//  using bf3_k7_t = dtl::bloomfilter_h3<key_t, hash_fn_0, hash_fn_1, hash_fn_2, word_t, dtl::mem::numa_allocator<word_t>, 7,   true>;
  using bf3_k8_t = dtl::bloomfilter_h3<key_t, hash_fn_0, hash_fn_1, hash_fn_2, word_t, dtl::mem::numa_allocator<word_t>, 8,   true>;
//  using bf3_k9_t = dtl::bloomfilter_h3<key_t, hash_fn_0, hash_fn_1, hash_fn_2, word_t, dtl::mem::numa_allocator<word_t>, 9,   true>;
//  using bf3_k10_t = dtl::bloomfilter_h3<key_t, hash_fn_0, hash_fn_1, hash_fn_2, word_t, dtl::mem::numa_allocator<word_t>, 10, true>;
//  using bf3_k11_t = dtl::bloomfilter_h3<key_t, hash_fn_0, hash_fn_1, hash_fn_2, word_t, dtl::mem::numa_allocator<word_t>, 11, true>;

//  using bf3_k6_mod_t = dtl::bloomfilter_h3_mod<key_t, hash_fn_0, hash_fn_1, hash_fn_2, word_t, dtl::mem::numa_allocator<word_t>, 6,   true>;
//  using bf3_k7_mod_t = dtl::bloomfilter_h3_mod<key_t, hash_fn_0, hash_fn_1, hash_fn_2, word_t, dtl::mem::numa_allocator<word_t>, 7,   true>;
  using bf3_k8_mod_t = dtl::bloomfilter_h3_mod<key_t, hash_fn_0, hash_fn_1, hash_fn_2, word_t, dtl::mem::numa_allocator<word_t>, 8,   true>;
//  using bf3_k9_mod_t = dtl::bloomfilter_h3_mod<key_t, hash_fn_0, hash_fn_1, hash_fn_2, word_t, dtl::mem::numa_allocator<word_t>, 9,   true>;
//  using bf3_k10_mod_t = dtl::bloomfilter_h3_mod<key_t, hash_fn_0, hash_fn_1, hash_fn_2, word_t, dtl::mem::numa_allocator<word_t>, 10, true>;
//  using bf3_k11_mod_t = dtl::bloomfilter_h3_mod<key_t, hash_fn_0, hash_fn_1, hash_fn_2, word_t, dtl::mem::numa_allocator<word_t>, 11, true>;



  // The supported Bloom filter vectorization extensions.
//  using bf1_k1_vt = dtl::bloomfilter_h1_vec<key_t, hash_fn_0, word_t, dtl::mem::numa_allocator<word_t>, 1, true, unroll_factors_bf1[1]>;

//  using bf1_k1_mod_vt = dtl::bloomfilter_h1_mod_vec<key_t, hash_fn_0, word_t, dtl::mem::numa_allocator<word_t>, 1, true, unroll_factors_bf1[1]>;
#ifndef USE_BF2
  using bf1_k2_vt = dtl::bloomfilter_h1_vec<key_t, hash_fn_0, word_t, dtl::mem::numa_allocator<word_t>, 2, true, unroll_factors_bf1[2]>;
//  using bf1_k3_vt = dtl::bloomfilter_h1_vec<key_t, hash_fn_0, word_t, dtl::mem::numa_allocator<word_t>, 3, true, unroll_factors_bf1[3]>;
  using bf1_k4_vt = dtl::bloomfilter_h1_vec<key_t, hash_fn_0, word_t, dtl::mem::numa_allocator<word_t>, 4, true, unroll_factors_bf1[4]>;
//  using bf1_k5_vt = dtl::bloomfilter_h1_vec<key_t, hash_fn_0, word_t, dtl::mem::numa_allocator<word_t>, 5, true, unroll_factors_bf1[5]>;
//  using bf1_k6_vt = dtl::bloomfilter_h1_vec<key_t, hash_fn_0, word_t, dtl::mem::numa_allocator<word_t>, 6, true, unroll_factors_bf1[6]>;

  using bf1_k2_mod_vt = dtl::bloomfilter_h1_mod_vec<key_t, hash_fn_0, word_t, dtl::mem::numa_allocator<word_t>, 2, true, unroll_factors_bf1[2]>;
//  using bf1_k3_mod_vt = dtl::bloomfilter_h1_mod_vec<key_t, hash_fn_0, word_t, dtl::mem::numa_allocator<word_t>, 3, true, unroll_factors_bf1[3]>;
  using bf1_k4_mod_vt = dtl::bloomfilter_h1_mod_vec<key_t, hash_fn_0, word_t, dtl::mem::numa_allocator<word_t>, 4, true, unroll_factors_bf1[4]>;
//  using bf1_k5_mod_vt = dtl::bloomfilter_h1_mod_vec<key_t, hash_fn_0, word_t, dtl::mem::numa_allocator<word_t>, 5, true, unroll_factors_bf1[5]>;
//  using bf1_k6_mod_vt = dtl::bloomfilter_h1_mod_vec<key_t, hash_fn_0, word_t, dtl::mem::numa_allocator<word_t>, 6, true, unroll_factors_bf1[6]>;
#else
  using bf1_k2_vt = dtl::bloomfilter_h2_vec<key_t, hash_fn_0, hash_fn_1, word_t, dtl::mem::numa_allocator<word_t>, 2, true, unroll_factors_bf2[2]>;
//  using bf1_k3_vt = dtl::bloomfilter_h2_vec<key_t, hash_fn_0, hash_fn_1, word_t, dtl::mem::numa_allocator<word_t>, 3, true, unroll_factors_bf2[3]>;
  using bf1_k4_vt = dtl::bloomfilter_h2_vec<key_t, hash_fn_0, hash_fn_1, word_t, dtl::mem::numa_allocator<word_t>, 4, true, unroll_factors_bf2[4]>;
//  using bf1_k5_vt = dtl::bloomfilter_h2_vec<key_t, hash_fn_0, hash_fn_1, word_t, dtl::mem::numa_allocator<word_t>, 5, true, unroll_factors_bf2[5]>;
//  using bf1_k6_vt = dtl::bloomfilter_h2_vec<key_t, hash_fn_0, hash_fn_1, word_t, dtl::mem::numa_allocator<word_t>, 6, true, unroll_factors_bf2[6]>;

  using bf1_k2_mod_vt = dtl::bloomfilter_h2_mod_vec<key_t, hash_fn_0, hash_fn_1, word_t, dtl::mem::numa_allocator<word_t>, 2, true, unroll_factors_bf2[2]>;
//  using bf1_k3_mod_vt = dtl::bloomfilter_h2_mod_vec<key_t, hash_fn_0, hash_fn_1, word_t, dtl::mem::numa_allocator<word_t>, 3, true, unroll_factors_bf2[3]>;
  using bf1_k4_mod_vt = dtl::bloomfilter_h2_mod_vec<key_t, hash_fn_0, hash_fn_1, word_t, dtl::mem::numa_allocator<word_t>, 4, true, unroll_factors_bf2[4]>;
//  using bf1_k5_mod_vt = dtl::bloomfilter_h2_mod_vec<key_t, hash_fn_0, hash_fn_1, word_t, dtl::mem::numa_allocator<word_t>, 5, true, unroll_factors_bf2[5]>;
//  using bf1_k6_mod_vt = dtl::bloomfilter_h2_mod_vec<key_t, hash_fn_0, hash_fn_1, word_t, dtl::mem::numa_allocator<word_t>, 6, true, unroll_factors_bf2[6]>;
#endif

  using bf2_k2_vt = dtl::bloomfilter_h2_vec<key_t, hash_fn_0, hash_fn_1, word_t, dtl::mem::numa_allocator<word_t>, 2, true, unroll_factors_bf2[2]>;
//  using bf2_k3_vt = dtl::bloomfilter_h2_vec<key_t, hash_fn_0, hash_fn_1, word_t, dtl::mem::numa_allocator<word_t>, 3, true, unroll_factors_bf2[3]>;
  using bf2_k4_vt = dtl::bloomfilter_h2_vec<key_t, hash_fn_0, hash_fn_1, word_t, dtl::mem::numa_allocator<word_t>, 4, true, unroll_factors_bf2[4]>;
//  using bf2_k5_vt = dtl::bloomfilter_h2_vec<key_t, hash_fn_0, hash_fn_1, word_t, dtl::mem::numa_allocator<word_t>, 5, true, unroll_factors_bf2[5]>;
//  using bf2_k6_vt = dtl::bloomfilter_h2_vec<key_t, hash_fn_0, hash_fn_1, word_t, dtl::mem::numa_allocator<word_t>, 6, true, unroll_factors_bf2[6]>;
//  using bf2_k7_vt = dtl::bloomfilter_h2_vec<key_t, hash_fn_0, hash_fn_1, word_t, dtl::mem::numa_allocator<word_t>, 7, true, unroll_factors_bf2[7]>;

  using bf2_k2_mod_vt = dtl::bloomfilter_h2_mod_vec<key_t, hash_fn_0, hash_fn_1, word_t, dtl::mem::numa_allocator<word_t>, 2, true, unroll_factors_bf2[2]>;
//  using bf2_k3_mod_vt = dtl::bloomfilter_h2_mod_vec<key_t, hash_fn_0, hash_fn_1, word_t, dtl::mem::numa_allocator<word_t>, 3, true, unroll_factors_bf2[3]>;
  using bf2_k4_mod_vt = dtl::bloomfilter_h2_mod_vec<key_t, hash_fn_0, hash_fn_1, word_t, dtl::mem::numa_allocator<word_t>, 4, true, unroll_factors_bf2[4]>;
//  using bf2_k5_mod_vt = dtl::bloomfilter_h2_mod_vec<key_t, hash_fn_0, hash_fn_1, word_t, dtl::mem::numa_allocator<word_t>, 5, true, unroll_factors_bf2[5]>;
//  using bf2_k6_mod_vt = dtl::bloomfilter_h2_mod_vec<key_t, hash_fn_0, hash_fn_1, word_t, dtl::mem::numa_allocator<word_t>, 6, true, unroll_factors_bf2[6]>;
//  using bf2_k7_mod_vt = dtl::bloomfilter_h2_mod_vec<key_t, hash_fn_0, hash_fn_1, word_t, dtl::mem::numa_allocator<word_t>, 7, true, unroll_factors_bf2[7]>;

//  using bf3_k6_vt = dtl::bloomfilter_h3_vec<key_t, hash_fn_0, hash_fn_1, hash_fn_2, word_t, dtl::mem::numa_allocator<word_t>, 6,   true, unroll_factors_bf2[2]>;
//  using bf3_k7_vt = dtl::bloomfilter_h3_vec<key_t, hash_fn_0, hash_fn_1, hash_fn_2, word_t, dtl::mem::numa_allocator<word_t>, 7,   true, unroll_factors_bf2[3]>;
  using bf3_k8_vt = dtl::bloomfilter_h3_vec<key_t, hash_fn_0, hash_fn_1, hash_fn_2, word_t, dtl::mem::numa_allocator<word_t>, 8,   true, unroll_factors_bf2[4]>;
//  using bf3_k9_vt = dtl::bloomfilter_h3_vec<key_t, hash_fn_0, hash_fn_1, hash_fn_2, word_t, dtl::mem::numa_allocator<word_t>, 9,   true, unroll_factors_bf2[5]>;
//  using bf3_k10_vt = dtl::bloomfilter_h3_vec<key_t, hash_fn_0, hash_fn_1, hash_fn_2, word_t, dtl::mem::numa_allocator<word_t>, 10, true, unroll_factors_bf2[6]>;
//  using bf3_k11_vt = dtl::bloomfilter_h3_vec<key_t, hash_fn_0, hash_fn_1, hash_fn_2, word_t, dtl::mem::numa_allocator<word_t>, 11, true, unroll_factors_bf2[7]>;

//  using bf3_k6_mod_vt = dtl::bloomfilter_h3_mod_vec<key_t, hash_fn_0, hash_fn_1, hash_fn_2, word_t, dtl::mem::numa_allocator<word_t>, 6,   true, unroll_factors_bf2[2]>;
//  using bf3_k7_mod_vt = dtl::bloomfilter_h3_mod_vec<key_t, hash_fn_0, hash_fn_1, hash_fn_2, word_t, dtl::mem::numa_allocator<word_t>, 7,   true, unroll_factors_bf2[3]>;
  using bf3_k8_mod_vt = dtl::bloomfilter_h3_mod_vec<key_t, hash_fn_0, hash_fn_1, hash_fn_2, word_t, dtl::mem::numa_allocator<word_t>, 8,   true, unroll_factors_bf2[4]>;
//  using bf3_k9_mod_vt = dtl::bloomfilter_h3_mod_vec<key_t, hash_fn_0, hash_fn_1, hash_fn_2, word_t, dtl::mem::numa_allocator<word_t>, 9,   true, unroll_factors_bf2[5]>;
//  using bf3_k10_mod_vt = dtl::bloomfilter_h3_mod_vec<key_t, hash_fn_0, hash_fn_1, hash_fn_2, word_t, dtl::mem::numa_allocator<word_t>, 10, true, unroll_factors_bf2[6]>;
//  using bf3_k11_mod_vt = dtl::bloomfilter_h3_mod_vec<key_t, hash_fn_0, hash_fn_1, hash_fn_2, word_t, dtl::mem::numa_allocator<word_t>, 11, true, unroll_factors_bf2[7]>;
  ...
  >
  void
  _copy_and_bind(bloomfilter_runtime_sectorized& copy,
  ...
  construct(u32 k, u64 m) {
    ...
    bloomfilter_runtime_sectorized wrapper;
    wrapper.m = actual_m;
...
//            case 11: wrapper._construct_and_bind<bf3_k11_mod_t, bf3_k11_mod_vt>(m); break;
  ...
  make_copy(const dtl::mem::allocator_config allocator_config) {
    bloomfilter_runtime_sectorized copy;
    copy.h = h;
    copy.k = k;
    copy.m = m;
